...
<body class="p-1 bg-green-50 text-sm antialiased">
    <!-- for navbar mian -->
    <div
        ...
        <div class="antialiased navbar-sub-left flex">
            ...
            <div class="antialiased search-bar static flex items-center p-1">
                <input type="search" name="search"
                    class="relative px-2 py-1 ml-6 w-[180px] text-sm border border-gray-300 outline-none placeholder-green-600 rounded"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.4"
                    stroke="currentColor" class="absolute ml-[180px] w-4 h-4 text-green-800">
        ...
        <div class="nav-side w-.8/6 bg-white h-[610px] px-1 py-2 fixed top-10">
            <ul class="w-full mt-7">
                <li
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="m-[2px] pr-2 fill-[rgba(27,137,67,255)]"
                        height="1em"
                        viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path
                ...
                <li
                    class="h-10 flex justify-between hover:bg-gray-200 px-2 py-1 font-bold text-sm text-[rgba(27,137,67,255)]">
                    <a href="" class="flex hover:text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                            class="fill-[rgba(27,137,67,255)] m-[2px] pr-2" height="1em"
                            viewBox="0 0 576 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                            <path
                                d="M0 24C0 10.7 10.7 0 24 0H69.5c22 0 41.5 12.8 50.6 32h411c26.3 0 45.5 25 38.6 50.4l-41 152.3c-8.5 31.4-37 53.3-69.5 53.3H170.7l5.4 28.5c2.2 11.3 12.1 19.5 23.6 19.5H488c13.3 0 24 10.7 24 24s-10.7 24-24 24H199.7c-34.6 0-64.3-24.6-70.7-58.5L77.4 54.5c-.7-3.8-4-6.5-7.9-6.5H24C10.7 48 0 37.3 0 24zM128 464a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm336-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z" />
                        </svg>Orders</a><svg xmlns="http://www.w3.org/2000/svg" class="fill-[rgba(27,137,67,255)] pr-2"
                        height="1em"
                ...
                <li
                    ...
                    <a href="" class="flex hover:text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <path
                                d="M112 0C85.5 0 64 21.5 64 48V96H16c-8.8 0-16 7.2-16 16s7.2 16 16 16H64 272c8.8 0 16 7.2 16 16s-7.2 16-16 16H64 48c-8.8 0-16 7.2-16 16s7.2 16 16 16H64 240c8.8 0 16 7.2 16 16s-7.2 16-16 16H64 16c-8.8 0-16 7.2-16 16s7.2 16 16 16H64 208c8.8 0 16 7.2 16 16s-7.2 16-16 16H64V416c0 53 43 96 96 96s96-43 96-96H384c0 53 43 96 96 96s96-43 96-96h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V288 256 237.3c0-17-6.7-33.3-18.7-45.3L512 114.7c-12-12-28.3-18.7-45.3-18.7H416V48c0-26.5-21.5-48-48-48H112zM544 237.3V256H416V160h50.7L544 237.3zM160 368a48 48 0 1 1 0 96 48 48 0 1 1 0-96zm272 48a48 48 0 1 1 96 0 48 48 0 1 1 -96 0z" />
                        </svg>Shipments</a><svg xmlns="http://www.w3.org/2000/svg"
                        class="fill-[rgba(27,137,67,255)] pr-2" height="1em"
                        viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path
                            d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" />
                    </svg>
                ...
                <li
                    ...
                    <a href="" class="flex hover:text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg>Products</a><svg xmlns="http://www.w3.org/2000/svg"
                        class="fill-[rgba(27,137,67,255)] pr-2" height="1em"
                        viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path
                            d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" />
                ...
                <li
                    ...
                    <a href="" class="flex hover:text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg>Customers</a><svg xmlns="http://www.w3.org/2000/svg"
                        class="fill-[rgba(27,137,67,255)] pr-2" height="1em"
                        viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path
                            d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" />
                ...
                <li
                    ...
                    <a href="" class="flex hover:text-green-700"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        </svg>Marketing</a><svg xmlns="http://www.w3.org/2000/svg"
                        class="fill-[rgba(27,137,67,255)] pr-2" height="1em"
                        viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                        <path
                            d="M233.4 406.6c12.5 12.5 32.8 12.5 45.3 0l192-192c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L256 338.7 86.6 169.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l192 192z" />
            ...
            <small class="text-[10px] px-2 w-full text-[rgba(27,137,67,255)]">ACCOUNTING/REPORTS/MISCELLANEOUS</small>
            <ul class="w-full mt-3">
                <li class="h-10 flex hover:bg-gray-200 px-2 py-1 font-bold text-sm text-[rgba(27,137,67,255)]"><svg
